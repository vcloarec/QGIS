...
class CORE_EXPORT QgsGeometry
{
  ...
  public:
    ...
    */
     ...
     * \returns OperationResult a result code: success or reason of failure
     */
    OperationResult splitGeometry( const QgsCurve *curve,  QVector<QgsGeometry> &newGeometries SIP_OUT, bool topological, QgsPointSequence &topologyTestPoints SIP_OUT, bool splitFeature = true );
