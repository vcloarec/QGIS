...
void TestQgsProject::testAsynchronousLayerLoading()
{
  ...
  meshFiles << QStringLiteral( "lines.2dm" )
            << QStringLiteral( "mesh_shading.nc" )
            << QStringLiteral( "mesh_z_ws_d.nc" )
            << QStringLiteral( "mesh_z_ws_d_vel.nc" )
            << QStringLiteral( "quad_and_triangle.2dm" )
            << QStringLiteral( "quad_flower.2dm" )
            << QStringLiteral( "quad_flower_to_edit.2dm" )
            << QStringLiteral( "quad_flower_to_edit_expected.2dm" )
            << QStringLiteral( "refined_quad_flower.2dm" )
            << QStringLiteral( "simplebox_clm.nc" )
            << QStringLiteral( "trap_steady_05_3D.nc" )
            << QStringLiteral( "with_flat_face.2dm" )
            << QStringLiteral( "with_free_vertex_in_mesh.2dm" )
            << QStringLiteral( "with_manifold_face.2dm" )
            << QStringLiteral( "with_unique_shared_vertex.2dm" );
  ...
  rasterFiles << QStringLiteral( "band1_byte_attribute_table_epsg4326.tif" )
              ...
              << QStringLiteral( "band1_float32_noct_epsg4326.tif" )
  ...
  for ( const QString &meshFile : std::as_const( meshFiles ) )
  {
    layers << new QgsMeshLayer( QString( TEST_DATA_DIR ) + QStringLiteral( "/mesh/" ) + meshFile, meshFile, QStringLiteral( "mdal" ) );
  ...
  project->setFlag( Qgis::ProjectFlag::AllowAsynchronousProviderCreation, false );
  ...
  project->setFlag( Qgis::ProjectFlag::AllowAsynchronousProviderCreation, true );
  QVERIFY( project->write( projFile.fileName() ) );
  project = std::make_unique<QgsProject>();
